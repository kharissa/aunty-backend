...
@app.route("/precache-manifest.fa1623e253f2bf5998566d8a22fc92a0.js")
def precache():
    return app.send_static_file("build/precache-manifest.fa1623e253f2bf5998566d8a22fc92a0.js")
